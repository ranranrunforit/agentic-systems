...
L1 costs coverage (fewer sub-questions answered) and L2 costs synthesis quality; both are measured in the eval harness (`eval/harness.py --compare-routing`), which is what stops a lever from being pulled on cost grounds alone.
